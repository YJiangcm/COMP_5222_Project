...
def main():
    ...
    parser.add_argument("--flair_pred_file",
                        required=True,
                        help="path to the txt file that flair generates.")
    ...
    flair_pred2sample_pred(args.flair_pred_file, args.sample_pred_file)
    
    evaluate(args.sample_pred_file, args.test_file)
